...
## With slight changes by: Henri Grotzeck (henri_grotzeck@gmx.de)
...
def generate_launch_description():
    ...
    pkg_predator_prey = get_package_share_directory(
        'launch_gazebo')
    ...
    ign_resource_path = SetEnvironmentVariable(
        ...
        value=[
            ...
            os.path.join(pkg_predator_prey, 'worlds','ignition')
        ])
