...
class Robot():
    def __init__(self,ros_node:Node,robot_name:str,inital_state:env_utils.State,executor:rclpy.executors.MultiThreadedExecutor,random_pos:bool=False,env_id:int=0) -> None:
        ...
        self.twist_publisher = self.robot_node.create_publisher(Twist,robot_name+'/cmd_vel',1)
        ...
        self.camera_subscriber = self.robot_node.create_subscription(Image,robot_name+'/camera/image_raw',self.image_raw_callback,1)
    ...
    def set_intial_state(self,state:env_utils.State):
